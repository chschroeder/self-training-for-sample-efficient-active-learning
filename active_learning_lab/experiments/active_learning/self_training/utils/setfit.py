...
from typing import Dict, Iterable, Tuple, Type, Callable
...
def apply_setfit_memory_fix(clf, mini_batch_size):
    from setfit import SetFitModel
    del clf.model
    clf.model = SetFitModel.from_pretrained(
        clf.setfit_model_args.sentence_transformer_model,
        use_differentiable_head=False,
        batch_size=mini_batch_size
    )
    import types
    clf.model.model_body.fit = types.MethodType(fit, clf.model.model_body)
    return clf
