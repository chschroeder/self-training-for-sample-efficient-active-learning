# setfit 2.2.2
# https://github.com/UKPLab/sentence-transformers/blob/f38e91e1e505fb338f03ad80a2f2b473569c7591/sentence_transformers/SentenceTransformer.py
import json
import logging
import os
import shutil
        ...
        for epoch in trange(epochs, desc="Epoch", disable=not show_progress_bar):
            ...
            for _ in trange(steps_per_epoch, desc="Iteration", smoothing=0.05, disable=not show_progress_bar):
                for train_idx in range(num_train_objectives):
                    ...
                    weights = weights.to(self._target_device)
                    features = list(map(lambda batch: batch_to_device(batch, self._target_device), features))

                    if use_amp:
                        with autocast():
                            loss_value = loss_model(features, labels, weights)
