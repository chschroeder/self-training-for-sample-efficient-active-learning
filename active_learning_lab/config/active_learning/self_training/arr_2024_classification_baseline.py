...
EXPERIMENT_NAME = 'arr24-self-training-classification-baseline'
...
DEFAULT_CONFIG = {
    ...
    'active_learner': {
        ...
        'active_learner_type': 'self-training',
        'active_learner_kwargs': {
            # self_training_method must be set
            #'self_training_method': 'verips-m',
            #'self_training_method': 'actune',
            #'self_training_method': 'nest',
            #'self_training_method': 'verips-m',
            #'self_training_method': 'ust',
            'self_training_method': 'hast',
        ...
        'initialization_strategy_kwargs': dict({
            'num_instances': NUM_INITIAL_INSTANCES + QUERY_SIZE * NUM_QUERIES
        }),
...
def set_defaults(config: providers.Configuration, override_args: dict) -> None:
    ...
    if override_args['classifier']['classifier_name'] == 'setfit-ext':
        ...
        new_dict['classifier']['classifier_kwargs']['trainer_kwargs'] = {
            # 'sentence_pair_generation_method': 'new',
            'num_epochs': 1,
            'learning_rate': 2e-5,
            'num_iterations': 1
        }
